...
const Features = () => {
  return (
    <section className="py-12 bg-white sm:py-12 lg:py-12">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-base leading-7 text-gray-600 sm:mt-8 font-pj">  AESTHCO was started with a simple idea: create quiet, well–made clothing for people who are tired of loud,
            over-designed fashion. We focus on clean silhouettes, neutral tones, and fabrics that feel good on skin and
            hold up in real life. Every hoodie, tee, and future piece is designed to be easy to wear, easy to style, and
            something you actually reach for every day.</p>
        </div>

        <div className="grid grid-cols-1 mt-6 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-gray-900/5 via-white/0 to-gray-900/10 opacity-0 transition duration-300 group-hover:opacity-100" />
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">  Have a question about sizing, orders, or shipping? Our support team is here to help you pick the right fit,
                  solve issues quickly, and keep your experience with AESTHCO smooth from checkout to delivery.</p>
              </div>
            </div>
          </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">
                  Whether you’re placing a single order or planning a bulk or corporate purchase, our sales team can guide you
                  through pricing, availability, and timelines so you get exactly what you need, when you need it.
                </p>              </div>
            </div>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">
                  New to AESTHCO? We’ll help you understand our fits, fabrics, and care instructions so your first purchase
                  feels easy and you know exactly what to expect from our essentials.
                </p>              </div>
            </div>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">
                  Every piece starts with fabric and fit. Our product team focuses on clean silhouettes, neutral tones, and
                  everyday comfort so you get clothing that looks minimal but feels considered in every detail.
                </p>              </div>
            </div>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">
                  From stitching and shrinkage control to color fastness and hand feel, we test our garments to make sure they
                  hold up to real, repeated wear—not just photoshoots.
                </p>              </div>
            </div>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/80 px-8 py-10 transition duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">
                  The result is simple: pieces you actually reach for every day. Calm, reliable essentials that fit well,
                  feel good, and quietly become part of your regular rotation.
                </p>              </div>
            </div>
          </div>
        </div>
